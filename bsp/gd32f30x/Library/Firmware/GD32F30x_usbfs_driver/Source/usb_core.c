...
usb_status_enum usb_hostchannel_init(usb_core_handle_struct *pudev, uint8_t hc_num) {
    ...
    switch (puhc->endp_type) {
        ...
        case USB_EPTYPE_BULK:
            chinten |= HCHINTEN_TFIE | HCHINTEN_STALLIE | HCHINTEN_USBERIE | HCHINTEN_DTERIE | HCHINTEN_NAKIE;
        ...
        case USB_EPTYPE_INTR:
            chinten |= HCHINTEN_TFIE | HCHINTEN_STALLIE | HCHINTEN_USBERIE | HCHINTEN_DTERIE | HCHINTEN_NAKIE | HCHINTEN_REQOVRIE;
...
static usb_status_enum usb_devint_enable(usb_core_handle_struct *pudev) {
    ...
    int_mask |= GINTEN_SPIE | GINTEN_RSTIE | GINTEN_ENUMFIE | GINTEN_IEPIE | GINTEN_OEPIE | GINTEN_SOFIE | GINTEN_ISOONCIE | GINTEN_ISOINCIE;
